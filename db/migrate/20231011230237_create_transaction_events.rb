class CreateTransactionEvents < ActiveRecord::Migration[7.1]
  def change
    create_table :transaction_events, id: false do |t|
      ...
      t.string :event_type
      t.json :event_data
      t.timestamp :event_timestamp, default: -> { 'CURRENT_TIMESTAMP' }
    end
  end
end
